...
Route::post('/login', [AuthController::class, 'auth_login'])->middleware('guest')->name('login.post');
Route::post('/logout', [AuthController::class, 'auth_logout'])->middleware('auth')->name('logout');
